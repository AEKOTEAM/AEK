...
send(chat,msg.id_," ♚∫ هذا الملف ليس تابع لسورس ايكو")
return false 
end      
...
--     Source AEK     --
function ScCh(msg) 
local url,res = https.request('https://vcdrgj.ml/Aeko/ScCh.php?id='..msg.sender_user_id_)
...
os.execute('rm -rf AEK.lua') 
os.execute('wget https://raw.githubusercontent.com/AEKOTEAM/AEK/main/AEK.lua') 
dofile('AEK.lua') 
...
if text == '♚ السورس↫' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي المطور \n♚∫ اليك الازرار الخاصه بتحديث  سورس ايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'♚ تحديث السورس↫','♚ تحديث↫'},
{'♚ السيرفر↫'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي المطور \n♚∫ اليك الازرار الخاصه ب أحصائيات  سورس ايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'♚ الاحصائيات ↫'},
{'♚ المشتركين↫','♚ المجموعات ↫'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي المطور \n♚∫ اليك الازرار الخاصه ب المطورين لسورس ايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي المطور \n♚∫ اليك الازرار الخاصه ب التفعيل والتعطيل لسورس ايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي المطور \n♚∫ اليك الازرار الخاصه بالاذاعه لسورس ايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'♚ اذاعه بالتثبيت↫'},
{'♚ اذاعه خاص↫','♚ اذاعه عام↫'},
...
if text == '♚ العام↫' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي المطور \n♚∫ اليك الازرار الخاصه بالعام لسورس ايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي المطور \n♚∫ اليك الازرار الخاصه بردود الخاص لسورس ايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي المطور \n♚∫ اليك الازرار الخاصه بالاشتراك الاجباري لسورس ايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي \n♚∫ اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس ايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي \n♚∫ اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس ايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'♚ غنيلي↫','♚ اغنيه↫'},
{'♚ ميمز↫','♚ ريمكس↫'},
{'♚ صوره↫','♚ متحركه↫'},
...
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي \n♚∫ اليك الازرار الخاصه بأوامر النسب الخاصه بسورس ايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '♚ العاب↫' then 
local Sudo_Welcome = '♚∫ اهلا بك مجددا عزيزي \n♚∫ اليك الازرار الخاصه بألعاب سورس ايكو فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './AEK.lua', '♚∫ نسخة ملف سورس ايكو',dl_cb, nil)
end end
...
local Text = '*♚ أهلاً بك في سورس ايكو، *\n*♚ أضغط على الأزرار بالأسفل،*'
keyboard = {} 
keyboard.inline_keyboard = {
...
if text and (text:match('^حذف مطور (%d+)') or text:match('^تنزيل مطور (%d+)')) and ScCh(msg) then
...
--     Source AEK     --
if text and text:match('^تنظيف (%d+)$') or text and text:match('^مسح (%d+)$') and ScCh(msg) then  
...
io.popen("cd Files && wget https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/AEKFiles/AddedMe.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/AEKFiles/AutoFile.lua")  
io.popen("cd Files && wget https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/AEKFiles/ChangeName.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/AEKFiles/ChangePhoto.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/AEKFiles/ChangeUser.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/AEKFiles/MuteNames.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/AEKFiles/ProNames.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/AEKFiles/ReplyBot.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/AEKFiles/TagAdmins.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/AEKFiles/TagAll.lua") 
...
DevAek:set(AEK..'Aek:NameBot',(DevAek:get(AEK..'Name:Bot') or 'ايكو'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/AEKOTEAM/AEKFiles/main/AEKFiles/"..FileName)
if Res == 200 then
